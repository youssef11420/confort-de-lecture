...
header("Location: $parserUrl?cdlid=$idSite&cdlurl=".urlencode(preg_replace("{^/}", "", $pageOriginale))."&cdlfirst=1&cdlbc=$coulEcran&cdlfc=$coulTexte&cdlfs=$tailleTexte&cdljs=".$_cdlJs."&cdlframes=".$_cdlFrames."&cdlimg=".$_cdlImg."&cdlobject=".$_cdlObj."&cdlapplet=".$_cdlApplet."&cdtable=".$_cdlTables."&cdlstyle=".$_REQUEST['style']);
