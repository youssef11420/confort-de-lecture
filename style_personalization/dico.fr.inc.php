...
#########################################################################
	...
	$dico['_DICO_BOUTON_APERCU'] = "<span>a</span><span>p</span><span>e</span><span>r</span><span>ç</span><span>u</span>";


	$dico['_DICO_PARAMETRES_AVANCES_LEGENDE'] = "Paramètres avancés";

	$dico['_DICO_PARAMETRES_AVANCES_OUI'] = "oui";
	$dico['_DICO_PARAMETRES_AVANCES_NON'] = "non";
	
	$dico['_DICO_PARAMETRES_AVANCES_JS'] = "Activer les scripts";
	$dico['_DICO_PARAMETRES_AVANCES_FRAME'] = "Activer les cadres (frames/iframes)";
	$dico['_DICO_PARAMETRES_AVANCES_IMG'] = "Afficher les images";
	$dico['_DICO_PARAMETRES_AVANCES_OBJECT'] = "Afficher les flashs, audios, vidéos";
	$dico['_DICO_PARAMETRES_AVANCES_APPLET'] = "Afficher les applets Java";
	$dico['_DICO_PARAMETRES_AVANCES_TABLE'] = "Linéariser les tableaux";
	
	$dico['_DICO_PARAMETRES_AVANCES_JS_INFO'] = "(si 'non' est coché, le fonctionnement alternatif est activé)";
	$dico['_DICO_PARAMETRES_AVANCES_FRAME_INFO'] = "(si 'non' est coché, le contenu alternatif est affiché)";
	$dico['_DICO_PARAMETRES_AVANCES_IMG_INFO'] = "(si 'non' est coché, le contenu alternatif est affiché)";
	$dico['_DICO_PARAMETRES_AVANCES_OBJECT_INFO'] = "(si 'non' est coché, le contenu alternatif est affiché)";
	$dico['_DICO_PARAMETRES_AVANCES_APPLET_INFO'] = "(si 'non' est coché, le contenu alternatif est affiché)";
	$dico['_DICO_PARAMETRES_AVANCES_TABLE_INFO'] = "(les transformer en listes à puce)";


	$dico['_DICO_BOUTON_ACCEDER'] = "Accédez au site";
	$dico['_DICO_OU'] = "ou";
	...
	$dico['_DICO_ERREUR_CONFIRM_PASSWORD_PASSWORD_ENREGISTRER'] = "- La confirmation du mot de passe n'est pas identifique au mot de passe";
	$dico['_DICO_ERREUR_UTILISATEUR_EXISTE_DEJA'] = "- L'identifiant founi existe déjà.";

	$dico['_DICO_VALEUR_LOGIN_ENREGISTRER'] = "Identifiant";
	$dico['_DICO_ENREGISTRER_PROFIL'] = "Enregistrez votre profil personnalisé et accédez au site";
	$dico['_DICO_LABEL_LOGIN_ENREGISTRER'] = "Créez votre identifiant&nbsp;:";
	$dico['_DICO_LABEL_PASSWORD_ENREGISTRER'] = "Choisissez votre mot de passe&nbsp;:";
	$dico['_DICO_LABEL_CONFIRM_PASSWORD_ENREGISTRER'] = "Confirmez votre mot de passe&nbsp;:";
	$dico['_DICO_BOUTON_VALIDER_ENREGISTRER'] = "Enregistrer et accéder au site";
