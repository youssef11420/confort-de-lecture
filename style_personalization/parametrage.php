...
// Paramètres avancés
if ($_REQUEST['avances']==1) {
	$_SESSION["activateJs"] = $_REQUEST['activateJavascript'] ? "1" : "0";
	$_SESSION["activateFrames"] = $_REQUEST['activateFrames'] ? "1" : "0";
	$_SESSION["displayImages"] = $_REQUEST['displayImages'] ? "1" : "0";
	$_SESSION["displayObjects"] = $_REQUEST['displayObjects'] ? "1" : "0";
	$_SESSION["displayApplets"] = $_REQUEST['displayApplets'] ? "1" : "0";
	$_SESSION["parseTables"] = $_REQUEST['parseTablesToList'] ? "1" : "0";
}
		...
		<div class="group">
			<form action="palette.php" method="post" id="formPalette">
				<div class="cache">
					...
					<input type="hidden" name="cdlJs" value="<?=$_SESSION["activateJs"]?>" />
					<input type="hidden" name="cdlFrames" value="<?=$_SESSION["activateFrames"]?>" />
					<input type="hidden" name="cdlImg" value="<?=$_SESSION["displayImages"]?>" />
					<input type="hidden" name="cdlObj" value="<?=$_SESSION["displayObjects"]?>" />
					<input type="hidden" name="cdlApplet" value="<?=$_SESSION["displayApplets"]?>" />
					<input type="hidden" name="cdlTables" value="<?=$_SESSION["parseTables"]?>" />
					<input type="hidden" name="id" value="<?=$idSite?>" />
				...
				<div id="divContenuConfigsApercu">
								...
								<fieldset class="encadrementImage">
									...
									<ul class="palette" id="backColor">
										<li <?=$selBackBlack?>>
											<script type="text/javascript">
											//<!--
											document.write("<label for=\"backColor000000\" style=\"background-color: black;color: black;border: 1px solid white;height: 64px !important;height: 66px !important!;width: 64px !important;width: 66px !important!;\"><?=$dico['_DICO_LABEL_FOND_NOIR']?></label><input type=\"radio\" value=\"000000\" name=\"backcolor\" id=\"backColor000000\" onfocus=\"modifCouleurFond(this);\" />");
											//--></script><noscript><div style="display:inline;"><label for="backColor000000" style="background-color: black;color: black;border: 1px solid white;height: 64px !important;height: 66px !important!;width: 64px !important;width: 66px !important!;"><a href="parametrage.php?style=<?=$_REQUEST['style']?>&amp;p=<?=$_REQUEST["p"]?>&amp;id=<?=$idSite?>&amp;typ=F&amp;class=backColor000000&amp;c=000000#fond" style="display:block;font-size:100%; width:66px;height:66px;color:#000000"><span style="display:none"><?=$dico['_DICO_LABEL_FOND_NOIR']?></span></a></label><input type="radio" value="000000" name="backcolor" id="backColor000000" onfocus="modifCouleurFond(this);" /></div></noscript>
										</li>
										<li <?=$selBackWhite?>>
											<script type="text/javascript">
											//<!--
											document.write("<label for=\"backColorFFFFFF\" style=\"background-color: white;color: white;border: 1px solid black;height: 64px !important;height: 66px !important!;width: 64px !important;width: 66px !important!;\"><?=$dico['_DICO_LABEL_FOND_BLANC']?></label><input type=\"radio\" value=\"FFFFFF\" name=\"backcolor\" id=\"backColorFFFFFF\" onfocus=\"modifCouleurFond(this);\" />");
											//--></script><noscript><div style="display:inline;"><label for="backColorFFFFFF" style="background-color: white;color: white;"><a href="parametrage.php?style=<?=$_REQUEST['style']?>&amp;p=<?=$_REQUEST["p"]?>&amp;id=<?=$idSite?>&amp;typ=F&amp;class=backColorFFFFFF&amp;c=FFFFFF#fond" style="display:block;font-size:100%;border: 1px solid black;height: 64px !important;height: 66px !important!;width: 64px !important;width: 66px !important!;"><span style="display:none"><?=$dico['_DICO_LABEL_FOND_BLANC']?></span></a></label><input type="radio" value="FFFFFF" name="backcolor" id="backColorFFFFFF" onfocus="modifCouleurFond(this);" /></div></noscript>
										</li>
										<li <?=$selBackGreen?>>
											<script type="text/javascript">
											//<!--
											document.write("<label for=\"backColor009900\" style=\"background-color: #009900;color: #009900;\"><?=$dico['_DICO_LABEL_FOND_VERT']?></label><input type=\"radio\" value=\"009900\" name=\"backcolor\" id=\"backColor009900\" onfocus=\"modifCouleurFond(this);\" />");
											//--></script><noscript><div style="display:inline;"><label for="backColor009900" style="background-color: #009900;color: #009900;"><a href="parametrage.php?style=<?=$_REQUEST['style']?>&amp;p=<?=$_REQUEST["p"]?>&amp;id=<?=$idSite?>&amp;typ=F&amp;class=backColor009900&amp;c=009900#fond" style="display:block;font-size:100%; width:66px;height:66px;color:#009900;"><span style="display:none"><?=$dico['_DICO_LABEL_FOND_VERT']?></span></a></label><input type="radio" value="009900" name="backcolor" id="backColor009900" onfocus="modifCouleurFond(this);" /></div></noscript>
										</li>
										<li <?=$selBackYellow?>>
											<script type="text/javascript">
											//<!--
											document.write("<label for=\"backColorFFFF00\" style=\"background-color: #FFFF00;color: #FFFF00;\"><?=$dico['_DICO_LABEL_FOND_JAUNE']?></label><input type=\"radio\" value=\"FFFF00\" name=\"backcolor\" id=\"backColorFFFF00\" onfocus=\"modifCouleurFond(this);\" />");
											//--></script><noscript><div style="display:inline;"><label for="backColorFFFF00" style="background-color: #FFFF00;color: #FFFF00;"><a href="parametrage.php?style=<?=$_REQUEST['style']?>&amp;p=<?=$_REQUEST["p"]?>&amp;id=<?=$idSite?>&amp;typ=F&amp;class=backColorFFFF00&amp;c=FFFF00#fond" style="display:block;font-size:100%; width:66px;height:66px;color:#FFFF00;"><span style="display:none"><?=$dico['_DICO_LABEL_FOND_JAUNE']?></span></a></label><input type="radio" value="FFFF00" name="backcolor" id="backColorFFFF00" onfocus="modifCouleurFond(this);" /></div></noscript>
										</li>
										<li <?=$selBackBlue?>>
											<script type="text/javascript">
											//<!--
											document.write("<label for=\"backColor0000FF\" style=\"background-color: #0000FF;color: #0000FF;\"><?=$dico['_DICO_LABEL_FOND_BLEU']?></label><input type=\"radio\" value=\"0000FF\" name=\"backcolor\" id=\"backColor0000FF\" onfocus=\"modifCouleurFond(this);\" />");
											//--></script><noscript><div style="display:inline;"><label for="backColor0000FF" style="background-color: #0000FF;color: #0000FF;"><a href="parametrage.php?style=<?=$_REQUEST['style']?>&amp;p=<?=$_REQUEST["p"]?>&amp;id=<?=$idSite?>&amp;typ=F&amp;class=backColor0000FF&amp;c=0000FF#fond" style="display:block;font-size:100%; width:66px;height:66px;color:#0000FF;"><span style="display:none"><?=$dico['_DICO_LABEL_FOND_BLEU']?></span></a></label><input type="radio" value="0000FF" name="backcolor" id="backColor0000FF" onfocus="modifCouleurFond(this);" /></div></noscript>
										</li>
									</ul>
								...
								<fieldset class="encadrementImage">
									...
									<ul class="palette" id="textColor">
										<li <?=$selTxtColorBlack?>>
											<script type="text/javascript">
											//<!--
											document.write("<label for=\"textColor000000\" style=\"background: url(images/textblack.png) center no-repeat;\"><span><?=$dico['_DICO_LABEL_TEXTE_NOIR']?></span></label><input type=\"radio\" value=\"000000\" name=\"textColor\" id=\"textColor000000\" onfocus=\"modifTailleTxt(this);\" />");
											//--></script><noscript><div style="display:inline;"><label for="textColor000000" style="background: url(images/textblack.png) center no-repeat;"><a<?=$classSelectedJs?> href="parametrage.php?style=<?=$_REQUEST['style']?>&amp;p=<?=$_REQUEST["p"]?>&amp;id=<?=$idSite?>&amp;typ=CC&amp;class=textColor000000&amp;c=000000#couleur" style="display:block;font-size:10%; width:66px;height:66px;color:#000000;"><span style="display:none"><?=$dico['_DICO_LABEL_TEXTE_NOIR']?></span></a></label><input type="radio" value="000000" name="textColor" id="textColor000000" onfocus="modifTailleTxt(this);" /></div></noscript>								
										</li>
										<li <?=$selTxtColorWhite?>>
											<script type="text/javascript">
											//<!--
											document.write("<label for=\"textColorFFFFFF\" style=\"background: url(images/textwhite.png) center no-repeat;\"><span><?=$dico['_DICO_LABEL_TEXTE_BLANC']?></span></label><input type=\"radio\" value=\"FFFFFF\" name=\"textColor\" id=\"textColorFFFFFF\" onfocus=\"modifTailleTxt(this);\" />");
											//--></script><noscript><div style="display:inline;"><label for="textColorFFFFFF" style="background: url(images/textwhite.png) center no-repeat;"><a href="parametrage.php?style=<?=$_REQUEST['style']?>&amp;p=<?=$_REQUEST["p"]?>&amp;id=<?=$idSite?>&amp;typ=CC&amp;class=textColorFFFFFF&amp;c=FFFFFF#couleur" style="display:block;font-size:10%; width:66px;height:66px;color:#000000;"><span style="display:none"><?=$dico['_DICO_LABEL_TEXTE_BLANC']?></span></a></label><input type="radio" value="FFFFFF" name="textColor" id="textColorFFFFFF" onfocus="modifTailleTxt(this);" /></div></noscript>
										</li>
										<li <?=$selTxtColorGreen?>>
											<script type="text/javascript">
											//<!--
											document.write("<label for=\"textColor009900\" style=\"background: url(images/textgreen.png) center no-repeat;\"><span><?=$dico['_DICO_LABEL_TEXTE_VERT']?></span></label><input type=\"radio\" value=\"009900\" name=\"textColor\" id=\"textColor009900\" onfocus=\"modifTailleTxt(this);\" />");
											//--></script><noscript><div style="display:inline;"><label for="textColor009900" style="background: url(images/textgreen.png) center no-repeat;"><a href="parametrage.php?style=<?=$_REQUEST['style']?>&amp;p=<?=$_REQUEST["p"]?>&amp;id=<?=$idSite?>&amp;typ=CC&amp;class=textColor009900&amp;c=009900#couleur" style="display:block;font-size:10%; width:66px;height:66px;color:#000000;"><span style="display:none"><?=$dico['_DICO_LABEL_TEXTE_VERT']?></span></a></label><input type="radio" value="009900" name="textColor" id="textColor009900" onfocus="modifTailleTxt(this);" /></div></noscript>
										</li>
										<li <?=$selTxtColorYellow?>>
											<script type="text/javascript">
											//<!--
											document.write("<label for=\"textColorFFFF00\" style=\"background: url(images/textyellow.png) center no-repeat;\"><span><?=$dico['_DICO_LABEL_TEXTE_JAUNE']?></span></label><input type=\"radio\" value=\"FFFF00\" name=\"textColor\" id=\"textColorFFFF00\" onfocus=\"modifTailleTxt(this);\" />");
											//--></script><noscript><div style="display:inline;"><label for="textColorFFFF00" style="background: url(images/textyellow.png) center no-repeat;"><a href="parametrage.php?style=<?=$_REQUEST['style']?>&amp;p=<?=$_REQUEST["p"]?>&amp;id=<?=$idSite?>&amp;typ=CC&amp;class=textColorFFFF00&amp;c=FFFF00#couleur" style="display:block;font-size:10%; width:66px;height:66px;color:#000000;"><span style="display:none"><?=$dico['_DICO_LABEL_TEXTE_JAUNE']?></span></a></label><input type="radio" value="FFFF00" name="textColor" id="textColorFFFF00" onfocus="modifTailleTxt(this);" /></div></noscript>
										</li>
										<li <?=$selTxtColorBlue?>>
											<script type="text/javascript">
											//<!--
											document.write("<label for=\"textColor0000FF\" style=\"background: url(images/textblue.png) center no-repeat;\"><span><?=$dico['_DICO_LABEL_TEXTE_BLEU']?></span></label><input type=\"radio\" value=\"0000FF\" name=\"textColor\" id=\"textColor0000FF\" onfocus=\"modifTailleTxt(this);\" />");
											//--></script><noscript><div style="display:inline;"><label for="textColor0000FF" style="background: url(images/textblue.png) center no-repeat;"><a href="parametrage.php?style=<?=$_REQUEST['style']?>&amp;p=<?=$_REQUEST["p"]?>&amp;id=<?=$idSite?>&amp;typ=CC&amp;class=textColor0000FF&amp;c=0000FF#couleur" style="display:block;font-size:10%; width:66px;height:66px;color:#000000;"><span style="display:none"><?=$dico['_DICO_LABEL_TEXTE_BLEU']?></span></a></label><input type="radio" value="0000FF" name="textColor" id="textColor0000FF" onfocus="modifTailleTxt(this);" /></div></noscript>
										</li>
									</ul>
					...
					<div id="divApercu" <?=$divApercu?>>
						<table cellspacing="0"><tr><td id="apercu" title="<?=$dico['_DICO_TITLE_BOUTON_APERCU']?>" <?=$apercu?>><?=$dico['_DICO_BOUTON_APERCU']?></td></tr></table>
					</div>
				</div>
			</form>
			<form action="entreeDirect.php" method="post" id="entrerDirect">
				...
				<!-- Les fonctionnalités avancées seront très bientôt activées pour l'utilisateur :
				<br /><div class="inputSubmit" style="float:right;position:relative;bottom:-2em !important;"><input class="submit" type="submit" name="paramsAvances" value="<?=$dico['_DICO_PARAMETRES_AVANCES_LEGENDE']?>" /></div> -->
				<div id="divBoutons">
					<hr class="cache" />
