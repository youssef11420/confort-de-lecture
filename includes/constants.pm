...
$cdlSessionCachePath = '/includes/cache/session';
...
$cdlDocumentsCachePath = "/includes/cache/document/";

# String: $databaseHost
# L'adresse IP de la base de données
$databaseHost = '{ADRESSE_SERVEUR_BASE_DE_DONNEES}';

# String: $databaseName
# Le nom de la base de données
$databaseName = '{NOM_BASE_DE_DONNEES}';

# String: $databaseLogin
# L'utilisateur de la base de données
$databaseLogin = '{LOGIN_UTILISATEUR_BASE_DE_DONNEES}';

# String: $databasePassword
# Le mot de passe de l'utilisateur de la base de données
$databasePassword ='{MOT_DE_PASSE_UTILISATEUR_BASE_DE_DONNEES}';
