...
- Procédure d’installation
	...
	• Insérer les lignes suivantes à la fin du fichier de configuration d’Apache ssl.conf (dans le répertoire conf), et remplir les paramètres qui sont entre accolades { } :
		<VirtualHost *:443>
			ServerAdmin {ADRESSE_MAIL_WEBMASTER}
			DocumentRoot {REPERTOIRE__SOURCES_APPLICATION}
			ServerName {NOM_DE_DOMAINE}
