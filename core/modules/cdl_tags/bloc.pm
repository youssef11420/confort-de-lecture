...
# File: bloc.pm
#	Module de gestion des blocs CDL d'information

# Function: parseAllBlocs
#	Récupérer le contenu des balises cdlBloc et de les insérer dans la template générale de la page
#
# Paramètres:
...
#	$entirePageTemplateString - chaîne de la template générale de page où remplir la zone des blocs
#	$cadreTemplateString - chaîne template où remplir un bloc d'information
sub parseAllBlocs #($htmlCode, $siteRootUrl, $pagePath, $activateJavascript, $parseJavascript, $displayImages, $displayObjects, $displayApplets, $parseTablesToList, $activateFrames, $siteId, $pageUri, $trustedDomainNames, $entirePageTemplateString, $cadreTemplateString)
{
	...
	# - chaîne de la template générale de page où remplir la zone des blocs
	# - chaîne template où remplir un bloc d'information
	...
	return parseAllNavsBlocs($htmlCode, $siteRootUrl, $pagePath, $activateJavascript, $parseJavascript, $displayImages, $displayObjects, $displayApplets, $parseTablesToList, $activateFrames, $siteId, $pageUri, $trustedDomainNames, $entirePageTemplateString, $cadreTemplateString, 'cdlBloc', 'BLOCS', ('ordre' => 1, 'partie' => 0));
}
