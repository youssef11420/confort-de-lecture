<?
	...
	$dico['_DICO_LABEL_TRES_PETITE'] = "Muy pequeño tamaño";
	$dico['_DICO_LABEL_PETITE'] = "Pequeño tamaño";
	$dico['_DICO_LABEL_MOYENNE'] = "Mediano tamaño";
	$dico['_DICO_LABEL_GRANDE'] = "Grande tamaño";
	$dico['_DICO_LABEL_TRES_GRANDE'] = "Muy grande tamaño";
	...
	$dico['_DICO_BOUTON_APERCU'] = "<span>m</span><span>u</span><span>e</span><span>s</span><span>t</span><span>r</span><span>a</span>";

	$dico['_DICO_PARAMETRES_AVANCES_LEGENDE'] = "Parámetros avanzados";
	
	$dico['_DICO_PARAMETRES_AVANCES_OUI'] = "si";
	$dico['_DICO_PARAMETRES_AVANCES_NON'] = "no";
	
	$dico['_DICO_PARAMETRES_AVANCES_JS'] = "Activar el javascript";
	$dico['_DICO_PARAMETRES_AVANCES_FRAME'] = "Activar los frames e iframes";
	$dico['_DICO_PARAMETRES_AVANCES_IMG'] = "Mostrar las imágenes";
	$dico['_DICO_PARAMETRES_AVANCES_OBJECT'] = "Mostrar los objetos (flash, audios, vídeos)";
	$dico['_DICO_PARAMETRES_AVANCES_APPLET'] = "Mostrar applets Java";
	$dico['_DICO_PARAMETRES_AVANCES_TABLE'] = "Alinear los cuadros";
	
	$dico['_DICO_PARAMETRES_AVANCES_JS_INFO'] = "(si se selecciona \"no\", se activa el funcionamiento alternativo)";
	$dico['_DICO_PARAMETRES_AVANCES_FRAME_INFO'] = "(si se selecciona \"no\", se muestra el contenido alternativo)";
	$dico['_DICO_PARAMETRES_AVANCES_IMG_INFO'] = "(si se selecciona \"no\", se muestra el contenido alternativo)";
	$dico['_DICO_PARAMETRES_AVANCES_OBJECT_INFO'] = "(si se selecciona \"no\", se muestra el contenido alternativo)";
	$dico['_DICO_PARAMETRES_AVANCES_APPLET_INFO'] = "(si se selecciona \"no\", se muestra el contenido alternativo)";
	$dico['_DICO_PARAMETRES_AVANCES_TABLE_INFO'] = "(transformar en listas con viñetas)";


	$dico['_DICO_BOUTON_RESET'] = "Reiniciar";
	$dico['_DICO_BOUTON_ACCEDER'] = "Acceder al sitio Web";
	$dico['_DICO_OU'] = "o";
	...
	$dico['_DICO_ERREUR_CONFIRM_PASSWORD_PASSWORD_ENREGISTRER'] = "- La confirmación del nombre de usuario no es igual al nombre de usuario";
	$dico['_DICO_ERREUR_UTILISATEUR_EXISTE_DEJA'] = "- El nombre de usuario indicado ya existe.";
